...
@section('content')
    <div class="container">
        ...
        <div class="row margin-top-30">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <div class="row margin-top-5">
                    <div class="col-md-12">
                        <button type="button" class="pull-right btn btn-danger" data-toggle="modal" data-target="#setTrailerModal">¿Trailer incorrecto?</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="setTrailerModal" tabindex="-1" role="dialog" aria-labelledby="setTrailerModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <span data-target="#set-trailer-info" data-toggle="collapse" title="ayuda" class="clickable" aria-expanded="true"><i class="material-icons">info</i></span>
                        <div class="margin-top-10 collapse in" id="set-trailer-info" aria-expanded="true" style="">
                            <div class="well">
                                <p>Por ejemplo para el video de Youtube <a target="_blank" href="https://www.youtube.com/watch?v=G1IbRujko-A">https://www.youtube.com/watch?v=G1IbRujko-A</a>
